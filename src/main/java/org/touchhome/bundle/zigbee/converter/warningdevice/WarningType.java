 ...
 * <p>
 * Note that the duration is specified using the ISO-8601 duration format (see {@link Duration#parse(CharSequence)} for more details).
 */
public class WarningType {
   ...
   * @return The {@link WarningType} represented by the ESH command, or null if the command does not represent a {@link WarningType}.
   */
